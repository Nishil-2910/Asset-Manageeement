    ...
    Grid:
               function (objurl) {
                   $("#jqTable1").jqGrid({
                       ...
                       colNames: ['IMS No', 'Requester', 'RFC Date', 'Service Line', 'Service Line Module', 'Short Change Desc', 'Priority', 'Support', 'Work Type', 'Change Type', 'Change Category', 'PendingWith', 'Role Name', 'Control'],
                       colModel: [
                       ...
                       loadComplete: function () {
                           var table = this;
                           setTimeout(function () {                              
                               jQuery.MyPendingRFC.updateActionIcons(table);
                               jQuery.MyPendingRFC.updatePagerIcons(table);
                               jQuery.MyPendingRFC.enableTooltips(table);
                           }, 0);
                     ...
                     {},
                    {
                        ...
                        afterShowSearch: function (e) {                            
                            var form = $(e[0]);
                            var position = $("#PendingRFCRequests").offset();
